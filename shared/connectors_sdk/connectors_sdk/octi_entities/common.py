...
from connectors_sdk.octi_entities.enum import TLPLevel
from pydantic import AwareDatetime, BaseModel, ConfigDict, Field, PrivateAttr

# from connectors_sdk.octi_entities.analyses.external_reference import ExternalReference
...
class DomainObject(BaseEntity):
    ...
    # TODO: external_references: Optional[list[ExternalReference]] = Field(
...
class Observable(BaseEntity):
    ...
    ) -> Any:  # TODO: should return Indicator type
