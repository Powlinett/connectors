...
from connectors_sdk.octi_entities.common import BaseEntity, DomainObject, UploadedFile
from connectors_sdk.octi_entities.enum import Reliability, ReportType
